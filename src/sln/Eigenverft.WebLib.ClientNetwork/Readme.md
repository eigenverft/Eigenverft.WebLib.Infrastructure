...
```text
./                         you are here (this readme + Eigenverft.WebLib.ClientNetwork.slnx)
../../prj/Eigenverft.WebLib.ClientNetwork/    packable class library
../../prj/Eigenverft.WebLib.ClientNetwork.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.ClientNetwork/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.ClientNetwork.Tests/MSTestResults/Eigenverft.WebLib.ClientNetwork.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.ClientNetwork.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.ClientNetwork/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.ClientNetwork/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

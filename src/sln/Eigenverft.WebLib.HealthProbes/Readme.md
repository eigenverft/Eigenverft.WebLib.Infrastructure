...
```text
./                         you are here (this readme + Eigenverft.WebLib.HealthProbes.slnx)
../../prj/Eigenverft.WebLib.HealthProbes/    packable class library
../../prj/Eigenverft.WebLib.HealthProbes.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.HealthProbes/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.HealthProbes.Tests/MSTestResults/Eigenverft.WebLib.HealthProbes.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.HealthProbes.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.HealthProbes/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.HealthProbes/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

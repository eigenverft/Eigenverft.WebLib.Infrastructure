...
```text
./                         you are here (this readme + Eigenverft.WebLib.RequestTrafficShaping.slnx)
../../prj/Eigenverft.WebLib.RequestTrafficShaping/    packable class library
../../prj/Eigenverft.WebLib.RequestTrafficShaping.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.RequestTrafficShaping/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.RequestTrafficShaping.Tests/MSTestResults/Eigenverft.WebLib.RequestTrafficShaping.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.RequestTrafficShaping.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.RequestTrafficShaping/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.RequestTrafficShaping/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

...
```text
./                         you are here (this readme + Eigenverft.WebLib.Middleware.Primitives.slnx)
../../prj/Eigenverft.WebLib.Middleware.Primitives/    packable class library
../../prj/Eigenverft.WebLib.Middleware.Primitives.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.Middleware.Primitives/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.Middleware.Primitives.Tests/MSTestResults/Eigenverft.WebLib.Middleware.Primitives.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.Middleware.Primitives.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.Middleware.Primitives/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.Middleware.Primitives/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

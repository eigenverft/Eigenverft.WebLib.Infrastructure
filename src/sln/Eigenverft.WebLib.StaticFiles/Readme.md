...
```text
./                         you are here (this readme + Eigenverft.WebLib.StaticFiles.slnx)
../../prj/Eigenverft.WebLib.StaticFiles/    packable class library
../../prj/Eigenverft.WebLib.StaticFiles.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.StaticFiles/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.StaticFiles.Tests/MSTestResults/Eigenverft.WebLib.StaticFiles.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.StaticFiles.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.StaticFiles/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.StaticFiles/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

...
```text
./                         you are here (this readme + Eigenverft.WebLib.Hosting.DirectoryLayout.slnx)
../../prj/Eigenverft.WebLib.Hosting.DirectoryLayout/    packable class library
../../prj/Eigenverft.WebLib.Hosting.DirectoryLayout.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.Hosting.DirectoryLayout/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.Hosting.DirectoryLayout.Tests/MSTestResults/Eigenverft.WebLib.Hosting.DirectoryLayout.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.Hosting.DirectoryLayout.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.Hosting.DirectoryLayout/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.Hosting.DirectoryLayout/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

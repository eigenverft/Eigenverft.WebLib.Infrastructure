...
```text
./                         you are here (this readme + Eigenverft.WebLib.Hsts.slnx)
../../prj/Eigenverft.WebLib.Hsts/    packable class library
../../prj/Eigenverft.WebLib.Hsts.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.Hsts/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.Hsts.Tests/MSTestResults/Eigenverft.WebLib.Hsts.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.Hsts.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.Hsts/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.Hsts/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.

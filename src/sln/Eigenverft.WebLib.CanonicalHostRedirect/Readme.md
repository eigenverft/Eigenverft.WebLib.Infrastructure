...
```text
./                         you are here (this readme + Eigenverft.WebLib.CanonicalHostRedirect.slnx)
../../prj/Eigenverft.WebLib.CanonicalHostRedirect/    packable class library
../../prj/Eigenverft.WebLib.CanonicalHostRedirect.Tests/  tests (not packed)
```

Package metadata, license, icon, and release notes live in `src/prj/Eigenverft.WebLib.CanonicalHostRedirect/NugetAssets/`.
...
[Test results (trx)](../../prj/Eigenverft.WebLib.CanonicalHostRedirect.Tests/MSTestResults/Eigenverft.WebLib.CanonicalHostRedirect.Tests-net10.0.trx)
[Test results (html)](../../prj/Eigenverft.WebLib.CanonicalHostRedirect.Tests/MSTestResults/result-net10.0.html)
...
Creates one `.nupkg` in `src/prj/Eigenverft.WebLib.CanonicalHostRedirect/bin/Pack/` containing the library for all selected target frameworks. Test and optional benchmark projects are not packed.
...
Writes library output to `src/prj/Eigenverft.WebLib.CanonicalHostRedirect/bin/Publish/` for the highest selected target framework. This is a class library, not an executable.
